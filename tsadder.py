...
if len(sys.argv) > 1:
    # Assign the argument to the variable 'group'
    group = sys.argv[1]
else:
    # If the argument is not provided, ask the user to input the group name
    group = input(f'{INPUT}{lg} Username[Eg: Primer_Primer]: {r}')
